...
/**
 * GitHub Issues Generator for Celo Wallet Starter Kit
 * Generates 20 meaningful GitHub issues to encourage community contributions
 */
...
console.log('\n📝 To create these issues manually, you can use these commands:\n');
...
console.log('\n🛠️ GitHub CLI Commands (if you have gh CLI installed):\n');

issues.forEach((issue, index) => {
  console.log(`# Issue ${index + 1}: ${issue.title}`);
  console.log(`gh issue create --title "${issue.title}" --body "${issue.body.replace(/\n/g, '\\n').replace(/"/g, '\\"')}" --label "${issue.labels.join(',')}"`);
  console.log('');
});

console.log('\n💡 Alternative: Create issues via GitHub Web Interface');
console.log('1. Go to your repository on GitHub');
console.log('2. Click "Issues" tab');
console.log('3. Click "New issue"');
console.log('4. Copy the title and body from above');
console.log('5. Add appropriate labels');
